...
public class PageListener implements PagePhaseListener {
    ...
    public void afterPhase(PagePhaseEvent pagePhaseEvent) {
        ...
        //           System.out.println("Prepare render id");
        //       }
        //        if (id ==Lifecycle.PREPARE_MODEL_ID) {
        //            System.out.println("Prepare model id");
        //        }
        //
        //
        //        if (id == Lifecycle.APPLY_INPUT_VALUES_ID) {
        //            System.out.println("apply input values id");
        //        }
        //        if (id == Lifecycle.VALIDATE_MODEL_UPDATES_ID) {
        //            System.out.println("validate model updates id");
        //        }
        //        if (id == Lifecycle.PROCESS_COMPONENT_EVENTS_ID) {
        //            System.out.println("Process component event id");
        //        }
        //        if (id == Lifecycle.VALIDATE_INPUT_VALUES_ID) {
        //            System.out.println("validate input values id");
        //        }
        //        if (id == Lifecycle.INIT_CONTEXT_ID) {
        //            System.out.println("init context");
        //        }
        //        if (id == Lifecycle.PROCESS_UPDATE_MODEL_ID) {
        //            System.out.println("process update model id");
        //        }
        ...
        if (pagePhaseEvent.getPhaseId() == Lifecycle.PREPARE_RENDER_ID) {
            ...
            //                            if (wrappedRequest.getConnection().isClosed()) {
            //                                System.out.println("PageListener.java: Connection Closed in afterPhase()");
            //                            }else{
            //                                System.out.println("PageListener.java: Unable to Close the connectin in afterPhase()");
            //                            }
            //                        }else{
            //                            System.out.println("PageListener.java: Connection is already closed in afterPhase()");
            //                        }
    ...
    public void print(String message) {
        System.out.println("PageListener: " + message);
    }
